    ...
    <div className="mt-4">
      <Tooltips title="Difficulty">
        {editMode ? (
          ...
          <div className="flex flex-nowrap flex-row text-[12px] leading-[18px] h5 uppercase whitespace-nowrap">
            <img
              src="/images/difficulty-icon.svg"
              className="h-[31px] w-[31px] grow-0 h-auto w-auto mr-1"
              alt="Difficulty"
            />
